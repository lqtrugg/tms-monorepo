...
import { Plus, Search, UserPlus, UserX, ArrowRightLeft, Eye } from "lucide-react";
        ...
        <table className="w-full">
          <thead className="bg-zinc-100 border-b border-zinc-200">
            <tr>
              ...
              <th className="px-6 py-4 text-left text-sm font-medium text-zinc-600">Codeforces</th>
