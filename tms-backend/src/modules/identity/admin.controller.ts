...
import { getValidatedBody, getValidatedParams, validate } from '../../shared/middlewares/validate.js';
import { requireRoles } from './auth.rbac.js';
import { createTeacherByAdmin, listTeachersForAdmin, updateTeacherByAdmin } from './admin.service.js';
