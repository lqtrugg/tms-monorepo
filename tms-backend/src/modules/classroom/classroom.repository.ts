...
export class ClassroomRepository {
  ...
  classes() {
    return classRepository(this.manager);
  }

  classSchedules() {
    return classScheduleRepository(this.manager);
  }

  sessions() {
    return sessionRepository(this.manager);
  }
  ...
  findOwnedSchedule(teacherId: number, scheduleId: number): Promise<ClassSchedule | null> {
    return findOwnedSchedule(this.manager, teacherId, scheduleId);
  }
