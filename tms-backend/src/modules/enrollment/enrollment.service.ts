...
import { toStudentSummary } from './enrollment.mapper.js';
import {
...
export class EnrollmentService {
  ...
  listStudents(teacherId: number, filters: StudentListFilters): Promise<StudentSummary[]> {
    void this.db;
    return listStudents(teacherId, filters);
  }

  getStudentById(teacherId: number, studentId: number): Promise<StudentSummary> {
    return getStudentById(teacherId, studentId);
  }

  createStudent(teacherId: number, input: CreateStudentInput): Promise<StudentSummary> {
    return createStudent(teacherId, input);
  }
  ...
  updateStudent(
    ...
    return updateStudent(teacherId, studentId, input);
  }
  ...
  transferStudent(
    ...
    return transferStudent(teacherId, studentId, input);
  }

  bulkTransferStudents(teacherId: number, input: BulkTransferStudentsInput): Promise<StudentSummary[]> {
    return bulkTransferStudents(teacherId, input);
  }
  ...
  withdrawStudent(
    ...
    return withdrawStudent(teacherId, studentId, input);
  }

  bulkWithdrawStudents(teacherId: number, input: BulkWithdrawStudentsInput): Promise<StudentSummary[]> {
    return bulkWithdrawStudents(teacherId, input);
  }
  ...
  reinstateStudent(
    ...
    return reinstateStudent(teacherId, studentId, input);
  }
  ...
  archivePendingStudent(
    ...
    return archivePendingStudent(teacherId, studentId, input);
  }
}
